namespace PensiónEstudiantes
{
    internal class Pension
    {
        ...
        {
            if (promedio <= 13.99) return 0;
            else if (promedio <= 15.99) return 0.10 * determinaPension();
            else if (promedio <= 17.99) return 0.12 * determinaPension();
            else return 0.15 * determinaPension();
        }
